...
@section('content')
    ...
    <div class="flex justify-center">
        <div class="bg-white shadow rounded p-4 w-1/3">
            ...
            @endif
            <p><strong>City:</strong> {{ $user->town->name ?? 'Sin ciudad' }}</p>
        </div>
    </div>

    <div class="flex space-x-4 mb-4 mt-4 justify-center">
        <button
            data-url="{{ route('users.destroy', $user->uid) }}"
        ...
        <a href="{{ route('users.edit', $user->uid) }}" class="bg-blue-400 text-white px-4 py-2 rounded hover:bg-blue-600  transition-colors duration-100">Update</a>
    </div>
